        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-[50px] lg:gap-[90px] items-center">
          ...
          >
            <motion.p
              ...
              className="uppercase tracking-[2px] text-[#BA4B40] text-[14px] sm:text-[16px] font-semibold mb-[16px]"
            >
              MODERN & ELEGANT
            </motion.p>
            ...
            <motion.h2
              ...
              className="text-[32px] sm:text-[40px] 3xl:text-[48px] leading-[1.2] text-[#000000] font-faculty mb-[18px] font-medium"
            >
            ...
            <motion.p
              ...
              className="text-[15px] sm:text-[16px] 3xl:text-[18px] text-[#555555] pb-[16px] lg:pb-[24px] font-medium leading-[1.8]"
            >
            ...
            <div className="space-y-[20px] lg:space-y-[24px]">
              <motion.div
                ...
                className="flex items-start gap-[16px] sm:gap-[20px]"
              >
            ...
            <motion.button
              ...
              className="group cursor-pointer relative overflow-hidden rounded-full border border-[#BA4B40] px-6 sm:px-10 mt-[36px] lg:mt-[48px] py-3 sm:py-4 text-[#BA4B40]"
            >
          ...
          >
            <motion.div
              ...
              className="grid grid-cols-1 sm:grid-cols-2 gap-[20px] lg:gap-[30px]"
            >
              {images.map((item, index) => (
                <motion.div
                  ...
                  className="relative h-[350px] sm:h-[500px] lg:h-[700px] rounded-[20px] lg:rounded-[30px] overflow-hidden"
                >
                  <Image
                    src={item.image}
                    alt={item.alt}
